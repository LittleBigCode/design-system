...
function pointAt(cxy: any, radius: any, angle: any) {
  return [
...
function arcPath(cxy: any, radius: any, startAngle: any, angle: any) {
...
function colorFor(value: any, thresholds: any, fallback: any) {
